...
create_users_with_array_input(Ctx, PetstoreUserpetstoreUser) ->
    create_users_with_array_input(Ctx, PetstoreUserpetstoreUser, #{}).
...
create_users_with_array_input(Ctx, PetstoreUserpetstoreUser, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = PetstoreUserpetstoreUser,
    ContentTypeHeader = petstore_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
create_users_with_list_input(Ctx, PetstoreUserpetstoreUser) ->
    create_users_with_list_input(Ctx, PetstoreUserpetstoreUser, #{}).
...
create_users_with_list_input(Ctx, PetstoreUserpetstoreUser, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
